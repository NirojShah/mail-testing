...
function openFolder(imap, folderName, cb) {
    imap.openBox(folderName, false, cb);
}

function fetchAllEmailsFromFolder(folderName) {
    const imap = new Imap(imapConfig);

    imap.once('ready', function () {
        openFolder(imap, folderName, function (err, box) {
            if (err) {
